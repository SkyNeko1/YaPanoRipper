...
**YaPanoRipper** — инструмент для скачивания панорам Яндекс.Карт в оригинальном разрешении. Поддерживает уличные панорамы и аэрофотосъёмку. Склеивает изображение из тайлов и отдаёт единый JPEG.
